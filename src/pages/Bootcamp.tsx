...
import api, { PhaseData, RoleData, CTAData } from '../api';
...
export default function Bootcamp() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [phasesRes, rolesRes, ctaRes] = await Promise.all([
          api.get('/phases'),
          api.get('/roles'),
          api.get('/cta'),
        ]);
    ...
    <div className="pt-20">
      ...
      <section className="py-24 bg-mocha text-ivory relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            A rigorous, high-impact immersion program designed to transform your professional capabilities.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle title="Bootcamp Timeline" subtitle="Every day is a step closer to corporate excellence." />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle title="Role Breakdown" subtitle="Specialized tracks for diverse professional interests." />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-mocha rounded-[3rem] p-12 md:p-20 text-ivory relative overflow-hidden">
            <div className="relative z-10">
              <SectionTitle title="Program Outcomes" subtitle="What you will achieve by the end of the 12 days." light />
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
                <div className="space-y-8">
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <h4 className="text-xl font-display font-bold mb-2">Corporate Readiness</h4>
                      <p className="text-ivory/60">Master the soft skills and professional etiquette required in top-tier corporate environments.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-6">
                    <div className="w-12 h-12 rounded-2xl bg-gold/20 flex items-center justify-center text-gold shrink-0">2</div>
                    <div>
                      <h4 className="text-xl font-display font-bold mb-2">Strategic Thinking</h4>
                      <p className="text-ivory/60">Develop the ability to analyze complex business problems and propose viable solutions.</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-8">
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <h4 className="text-xl font-display font-bold mb-2">Execution Excellence</h4>
                      <p className="text-ivory/60">Learn how to take a project from ideation to final delivery with precision and quality.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-6">
                    <div className="w-12 h-12 rounded-2xl bg-gold/20 flex items-center justify-center text-gold shrink-0">4</div>
                    <div>
                      <h4 className="text-xl font-display font-bold mb-2">Industry Network</h4>
                      <p className="text-ivory/60">Build a professional network that will support your career growth for years to come.</p>
                    </div>
                  </div>
                </div>
              </div>
